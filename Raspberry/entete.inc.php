   ...
   <div>
	  ...
	  <?php   if(isset($_SESSION['login']) && isset($_SESSION['profil'])){  ?>         
         <div class="navbar-header">
		  <li><a class="navbar-brand"><font color="black">&nbsp; <?php echo $_SESSION['login']; ?></font></a></li>
		 </div>
		  <li><a href="contact.php"><span class="glyphicon glyphicon-list"></span> &nbsp; Contact</a></li>
          
					<li><a href="mainboard.php"><span class="glyphicon glyphicon-eye-open"></span>&nbsp;Votre page d'accueil</a></li>
					<?php
					if($_SESSION['profil'] != 1){ echo '<li><a href="panel_gestion.php"><span class="glyphicon glyphicon-off"></span> Votre panel de gestion</a></li>';
					 echo '<li><a href="modifProfil.php"><span class="glyphicon glyphicon-user"></span> Modifier votre profil</a></li>';
					}
